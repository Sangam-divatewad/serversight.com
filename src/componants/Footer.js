    ...
    <div className="mb-0    bg-black">
      <div className="container nav ">
        <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top ">
          <ul className="nav nav-tabs col-md-14  ">
            <li className="nav-item me-3">
              <h5 style={{ fontFamily: "sans" }} className="text-secondary">
                All content is promoted from corresponding News channels.
              </h5>
            </li>
            ...
            <li className="nav-item">
              <Link
                target={"blank"}
                to="mailto:sangamdivatewad@gmail.com"
                className=" nav-link px-2 py-2  "
              >
